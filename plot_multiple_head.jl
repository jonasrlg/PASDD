...
manager = SddMgr(4, :balanced)
knuth, pólya, church, vonNeumann = pos_literals(Sdd, manager, 4)
names_dict = Dict(1 => "knuth", -1 => "¬knuth", 2 => "pólya", -2 => "¬pólya", 3 => "church", -3 => "¬church", 4 => "vonNeumann", -4 => "¬vonNeumann")
body1 = pólya ∧ church
bodies = body1 ∨ vonNeumann
c = knuth ⇔ bodies

t_b = myPlot(bodies; simplify=false)
t = myPlot(c; simplify=true)

using TikzPictures

TikzPictures.save(PDF("multiple_head_body.pdf"), t_b)
TikzPictures.save(PDF("multiple_head.pdf"), t)
