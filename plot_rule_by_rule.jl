...
manager = SddMgr(6, :balanced)
turing, gödel, church, knuth, pólya, vonNeumann = pos_literals(Sdd, manager, 6)
names_dict = Dict(1 => "turing", -1 => "¬turing", 2 => "gödel", -2 => "¬gödel", 3 => "church", -3 => "¬church", 4 => "knuth", -4 => "¬knuth", 5 => "pólya", -5 => "¬pólya", 6 => "vonNeumann", -6 => "¬vonNeumann")
body_turing = gödel ∧ church
circuit_turing = turing ⇔ body_turing
body1 = pólya ∧ church
body_knuth= body1 ∨ vonNeumann
circuit_knuth = knuth ⇔ body_knuth
c = circuit_turing ∧ circuit_knuth

t = myPlot(c; simplify=true)

using TikzPictures

TikzPictures.save(PDF("rule_by_rule.pdf"), t)
